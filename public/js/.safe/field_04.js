...
//	this.USSIncludeLinks_("xml.js")
	this.USSField_()
	this.resourcesPath=window.location
}
...
USS.prototype.USSCreateAccordion=function()
{

this.ussTableAccordion= document.createElement("div");
this.ussTableAccordion.id= "container";
...
USS.prototype.USSCreateAccordion=function(title,table)
{
...
this.ussTableAccordionExpandDummy= document.createElement("div");
this.ussTableAccordionExpandDummy.appendChild(document.createTextNode("Expand All"));
...
this.ussTableAccordionDiv.appendChild(this.newContent);
this.ussTableAccordionH.appendChild(this.newContent);
...
this.ussTableAccordionH= document.createElement("div");
 ...
 this.ussTableAccordionH.className ="headline" ;//'ui-accordion-header ui-helper-reset ui-state-default ui-accordion-icons';
 // this.ussTableAccordionH.setAttribute('aria-controls' ,'ui-accordion-accordion-panel-1');
 // this.ussTableAccordionH.setAttribute('aria-selected', "false");


//<h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-icons aria-selected=&quot;false&quot; ui-corner-all" role="tab" id="ui-accordion-accordion-header-1" aria-controls="ui-accordion-accordion-panel-1" aria-selected="false" tabindex="-1"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-e"></span><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-e"></span>Customer2</h3>
//  this.ussTableAccordionH.border=1;
 
  //this.ussTableAccordion.id="accordion";


this.ussTableAccordionSpan= document.createElement("span");
 // this.ussTableAccordionSpan.className = 'ui-accordion-header-icon ui-icon ui-icon-triangle-1-s';
 // this.ussTableAccordionSpan.border=1;

 this.newContent = document.createTextNode(title);
  //this.ussTableAccordionSpan.innerText = title;
 ...
 this.ussTableAccordionDiv=document.createElement("div");
this.ussTableAccordionDiv.className ="section" ;
 // this.ussTableAccordion.className = 'ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active" id="ui-accordion-accordion-panel-0" aria-labelledby="ui-accordion-accordion-header-0';


//	<span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-s"></span>Section 1</h3>
//	<div class="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active" id="ui-accordion-accordion-panel-0" aria-labelledby="ui-accordion-accordion-header-0" role="tabpanel" aria-expanded="true" aria-hidden="false" style="display: block; height: 104.88888883590698px;">


  //this.ussTableAccordion.onclick = 'event.cancelBubble = true;';
  //this.ussTableAccordion.tabIndex = -1;

//this.ussTableAccordionDiv.appendChild(table);
...
USS.prototype.USSAppendAccordionExapnd=function(obj)
{
  ...
  this.ussTableAccordion=obj;  // --document.createElement("div");
 // this.ussTableAccordion.className = 'ui-accordion ui-widget ui-helper-reset';
  //this.ussTableAccordion.border=1;
 // this.ussTableAccordion.id="accordion";

//this.ussTableAccordionH= document.createElement("h3");
this.ussTableAccordionExpand= document.createElement("div");
 // this.ussTableAccordion.className = 'ui-accordion ui-widget ui-helper-reset';
 // this.ussTableAccordionExpand.border=1;
this.ussTableAccordionExpand.id="expand";
 // this.ussTableAccordionExpand.appendChild(document.createTextNode("Expand All"));
this.ussTableAccordionExpand.appendChild(document.createTextNode("Collapse All"));
//"Expand All"; //need to verify in firefox


// this.ussTableAccordionExpandDummy= document.createElement("div");
 // this.ussTableAccordion.className = 'ui-accordion ui-widget ui-helper-reset';
 // this.ussTableAccordionExpand.border=1;
  //this.ussTableAccordionExpandDummy.id="expand";
 // this.ussTableAccordionExpandDummy.appendChild(document.createTextNode("Expand All"));
//"Expand All"; //need to verify in firefox


this.ussTableAccordion.appendChild(this.ussTableAccordionExpand);
//this.ussTableAccordion.appendChild(this.ussTableAccordionExpandDummy);
