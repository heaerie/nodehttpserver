...
var searchAsYouTypeConfiguration = {
    ...
    //resourcesPath:"http://www.heaerie.com/mcar10.1.1/search-ragas/"
    resourcesPath:"../search-ragas/"
  ,

    // The fully qualified URL to the Ajax responder. 
    // e.g. http://intranet.company.com/search-as-you-type/responder.php
//    ajaxResponderUrl:"http://www.heaerie.com/mcar10.1.1/search-ragas/search-responder.php"
    ajaxResponderUrl:"../search-ragas/search-responder.php"
    ,
    ...
    //helpPageUrl:"http://www.heaerie.com/mcar10.1.1/search-ragas/help.html",
    helpPageUrl:"../search-ragas/help.html",
...
SearchAsYouType.prototype.createDomElements_ = function() {
  ...
  this.waitingForSearchResultsEl.src = 
    this.resourcesPath + "../img/loading.gif";
...
//alert('url:' +url);
    if (top.location != location) {
      ...
      location.href = url;
      document.forms[0].submit();//done fix by durai @20120527
    }
  } catch(e) {
    location.href = url;
  }
