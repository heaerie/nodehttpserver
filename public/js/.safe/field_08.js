...
this.ussTableAccordion.className="panel-group";
this.ussTableAccordion.setAttribute("data-parent", "accordion" + id);
...
//					this.tableBodyLabelContent = document.createTextNode(fieldObj.label.toLowerCase());
					this.tableBodyLabelContent = document.createTextNode(initCap(fieldObj.label.toLowerCase()));
				...
				if (fieldObj.htmlType == 'LIST') 
				{
					...
					this.tableBodySelect.name=fieldObj.group+'_'+fieldObj.name ;
					...
					for(var i=0 ; i< inpStrArr.length;i+=2)
					{
						if (fieldObj.entitle == 'READONLY') 
						{
							if (fieldObj.dflt ==inpStrArr[i] ) 
							{
								...
								fldStr='<input disabled="true" type="radio" checked=true dataType="'+fieldObj.dataType+'" htmlType="'+fieldObj.htmlType+'"    xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'"  parent="'+fieldObj.parent+'" id="'+fieldObj.name+'"  value="'+inpStrArr[i]+'"  onchange="javascript:'+ fieldObj.onchange+'" > '+ inpStrArr[i+1] ;
							}
							else
							{
								fldStr='<input disabled="true"   type="radio" dataType="'+fieldObj.dataType+'"   xmlname="'+fieldObj.name+'" htmlType="'+fieldObj.htmlType+'"   name="'+fieldObj.group+'_'+fieldObj.name+'"  parent="'+fieldObj.parent+'" id="'+fieldObj.name+'"  value="'+inpStrArr[i]+'"  onchange="javascript:'+ fieldObj.onchange+'" > '+ inpStrArr[i+1] ;
							}
						}
						else
						{
